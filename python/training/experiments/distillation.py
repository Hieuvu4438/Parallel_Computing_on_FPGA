...
"""
================================================================================
Knowledge Distillation Pipeline — 3-Class Respiratory Sound Classification
================================================================================
BTS-d++ inspired: Teacher Ensemble → Student distillation on ICBHI 2017.
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Knowledge Distillation for ICBHI')
    ...
    samples, class_to_idx = build_dataset_from_icbhi(args.data_dir, args.labels_file, logger)
